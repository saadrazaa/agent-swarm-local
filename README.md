...
**v1.131.1** with **agent-fs 0.12.2**. Persistent agent memory is provided by
...
| Component | Reference |
|---|---|
| API | `ghcr.io/desplega-ai/agent-swarm:1.131.1` |
| Worker | `ghcr.io/desplega-ai/agent-swarm-worker:1.131.1` |
